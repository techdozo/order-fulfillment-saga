...
import dev.techdozo.payment.infrastructure.temporal.workflow.activity.impl.PaymentActivitiesImpl;
...
public class PaymentServiceAppConfig {
  ...
  @Bean
  public PaymentActivities debitPaymentActivity(PaymentJpaRepository paymentJpaRepository) {
    return new PaymentActivitiesImpl(paymentService(), paymentRepository(paymentJpaRepository));
  }
