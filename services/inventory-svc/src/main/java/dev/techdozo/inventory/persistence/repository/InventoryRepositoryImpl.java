...
public class InventoryRepositoryImpl implements InventoryRepository {
  ...
  @Override
  public Optional<Inventory> getByOrderId(Long orderId) {
    return inventoryJpaRepository.findByOrderId(orderId).stream()
        .map(InventoryPersistableMapper.MAPPER::map)
        .findFirst();
  }
}
