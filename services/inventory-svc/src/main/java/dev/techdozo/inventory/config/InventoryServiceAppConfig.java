...
import dev.techdozo.inventory.infrastructure.temporal.workflow.activity.impl.InventoryActivitiesImpl;
...
public class InventoryServiceAppConfig {
  ...
  @Bean
  public InventoryActivities reserveInventoryActivity(
      InventoryJpaRepository inventoryJpaRepository) {
    return new InventoryActivitiesImpl(inventoryRepository(inventoryJpaRepository));
  }
